...
public class Flight implements Serializable {
    ...
    public String toString() {
        return "Flight #" + flightNumber + " | Departure: " + departureAirport.getSymbol() + " - " + departure.getDatePretty() + " " + departure.getTimePretty() + " | Arrival: " + arrivalAirport.getSymbol() + " - " + arrival.getDatePretty() + " " + arrival.getTimePretty();   
    }
}
